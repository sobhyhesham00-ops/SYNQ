...
export const generateInquiryCopyText = (inq: any): string => {
  ...
  const infoArray = [
    ...
    `Phone: ${inq.phoneNumber ? normalizePhone(inq.phoneNumber) : 'N/A'}${inq.instagramUser ? ` | IG: ${inq.instagramUser}` : ''}${inq.tiktokUser ? ` | TikTok: ${inq.tiktokUser}` : ''}`,
    `Status: ${inq.status}`,
...
export const generateTabbyTamaraCopyText = (req: any): string => {
  ...
  const infoArray = [
    ...
    `Phone: ${req.phoneNumber ? normalizePhone(req.phoneNumber) : 'N/A'}${req.instagramUser ? ` | IG: ${req.instagramUser}` : ''}${req.tiktokUser ? ` | TikTok: ${req.tiktokUser}` : ''}`,
...
export const generateComplaintCopyText = (comp: any): string => {
  ...
  const infoArray = [
    ...
    `Phone: ${comp.phoneNumber ? normalizePhone(comp.phoneNumber) : 'N/A'}${comp.instagramUser ? ` | IG: ${comp.instagramUser}` : ''}${comp.tiktokUser ? ` | TikTok: ${comp.tiktokUser}` : ''}`,
