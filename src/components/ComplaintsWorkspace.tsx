                ...
                <div className="w-full pl-2.5 overflow-hidden transition-all duration-300 mt-4 pt-4 border-t border-white/5 space-y-5 flex flex-col text-left">
                  ...
                  <div className="border bg-slate-800/20 border-white/5 p-4 rounded-xl flex items-center justify-between gap-4 flex-wrap">
                    <div className="text-left font-sans animate-fade-in">
                      <span className="text-[10px] text-slate-400 uppercase tracking-wider font-bold block mb-0.5 font-sans animate-fade-in">
                        ASSIGNED WORKER
                      </span>
                      <span className="text-xs text-slate-200 font-bold flex items-center gap-1 font-sans animate-fade-in">
                    ...
                    <div className="p-5 bg-rose-500/[0.02] border border-rose-500/20 rounded-xl space-y-4 animate-fade-in mt-1 text-left w-full">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2.5 text-xs text-slate-100 focus:outline-[#10b981] font-sans min-h-[100px] resize-none focus:outline-none focus:border-rose-500"
                          required
                        />
                      </div>
