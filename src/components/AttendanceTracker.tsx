  ...
  return (
    <div className="space-y-6 animate-fade-in text-left font-sans">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 bg-white/[0.03] border border-white/10 p-6 rounded-2xl">
        ...
        <div className="flex flex-wrap items-center gap-2 bg-slate-950/40 p-2 rounded-2xl border border-white/5">
          <button
          ...
          <div className="relative flex items-center gap-1.5 px-3 bg-white/5 border border-white/5 rounded-xl h-9">
            ...
            <input
              ...
              className="bg-transparent text-slate-100 text-xs font-bold font-sans focus:outline-none border-none cursor-pointer w-28 text-center"
            />
          </div>
      ...
      <div className="bg-transparent border border-white/5 p-5 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div className="space-y-1">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <input
              ...
              className="bg-slate-950/60 border border-white/10 rounded-xl px-3 py-1.5 text-xs font-sans text-slate-200 focus:border-indigo-500/50 focus:outline-none"
            />
          </div>
          <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-9 px-4 bg-indigo-600/90 hover:bg-indigo-600 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-sm active:scale-95 border border-indigo-500/10"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-3 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-slate-500" />
            <p className="text-xs uppercase font-bold text-slate-500 tracking-widest">Global Roster</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  ...
                  className="text-3xl font-bold text-slate-100 block"
                >
                  {stats.total}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="p-4 bg-emerald-500/10 border border-emerald-500/15 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-emerald-500" />
            <p className="text-xs uppercase font-bold text-emerald-400 tracking-widest">Present</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.present}
          ...
          <div className="p-4 bg-amber-500/10 border border-amber-500/15 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-amber-500" />
            <p className="text-xs uppercase font-bold text-amber-400 tracking-widest">Late</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.late}
                  ...
                  exit={{ opacity: 0, scale: 1.3 }}
                  transition={{ type: "spring", stiffness: 350, damping: 20 }}
                  className="text-3xl font-bold text-amber-400 block"
                >
                  {stats.late}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="p-4 bg-rose-500/10 border border-rose-500/15 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-rose-500" />
            <p className="text-xs uppercase font-bold text-rose-400 tracking-widest">Absent</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.absent}
                  ...
                  exit={{ opacity: 0, scale: 1.3 }}
                  transition={{ type: "spring", stiffness: 350, damping: 20 }}
                  className="text-3xl font-bold text-rose-400 block"
                >
                  {stats.absent}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="p-4 bg-blue-500/10 border border-blue-500/15 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-blue-500" />
            <p className="text-xs uppercase font-bold text-blue-400 tracking-widest">On Leave</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.onLeave}
          ...
          <div className="p-4 bg-slate-500/10 border border-slate-500/25 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-slate-500" />
            <p className="text-xs uppercase font-bold text-slate-300 tracking-widest">OFF</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.offCount}
                  ...
                  exit={{ opacity: 0, scale: 1.3 }}
                  transition={{ type: "spring", stiffness: 350, damping: 20 }}
                  className="text-3xl font-bold text-slate-300 block"
                >
                  {stats.offCount}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="p-4 bg-red-500/15 border border-red-500/25 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-red-500" />
            <p className="text-xs uppercase font-bold text-red-500 tracking-widest">NSNC</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  ...
                  exit={{ opacity: 0, scale: 1.3 }}
                  transition={{ type: "spring", stiffness: 350, damping: 20 }}
                  className="text-3xl font-bold text-red-500 block"
                >
                  {stats.noShowNoCall}
                </motion.span>
              </AnimatePresence>
          ...
          <div className="p-4 bg-slate-800/20 border border-white/5 rounded-2xl text-center flex flex-col justify-center relative overflow-hidden group">
            <div className="absolute top-0 inset-x-0 h-[3px] bg-slate-700" />
            <p className="text-xs uppercase font-bold text-slate-400 tracking-widest">Unmarked</p>
            <div className="h-9 flex items-center justify-center mt-1 relative">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  key={stats.notMarked}
                  ...
                  exit={{ opacity: 0, scale: 1.3 }}
                  transition={{ type: "spring", stiffness: 350, damping: 20 }}
                  className="text-3xl font-bold text-slate-400 block"
                >
                  {stats.notMarked}
                </motion.span>
              </AnimatePresence>
        ...
        <div className="bg-white/[0.02] border border-white/10 p-5 rounded-2xl flex flex-col">
      ...
      <div className="bg-transparent border border-white/5 p-5 rounded-2xl space-y-3">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
          ...
          <span className="text-xs font-bold font-sans text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-2.5 py-1 rounded-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-4 space-y-2 lg:sticky lg:top-4">
          <h3 className="text-xs font-bold uppercase text-slate-500 tracking-widest px-3 mb-2.5 flex items-center gap-2">
            ...
            {availableLOBs.map((lob) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-between gap-3 px-3 py-2.5 rounded-2xl w-full text-left font-semibold text-xs transition-all border shrink-0 lg:shrink-1 ${ isActive ? "bg-indigo-500/15 border-indigo-500/30 text-slate-100 shadow-sm" : "bg-transparent border-transparent text-slate-400 hover:text-slate-200 hover:bg-white/5" }`}
                >
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white/[0.03] border border-white/10 p-4 rounded-2xl">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-950/50 border border-white/5 focus:border-indigo-500/50 hover:border-white/10 rounded-2xl text-xs text-slate-200 placeholder-slate-500 focus:outline-none transition-all font-medium"
              />
            </div>
                          ...
                          >
                            ...
                            <td className="p-2.5 pl-4">
                              <div className="flex items-center gap-3 min-w-0">
                                <div className={`w-8 h-8 rounded-xl bg-gradient-to-br ${getLOBGradient(item.lob)} flex items-center justify-center text-white text-xs font-bold tracking-wider -sm shrink-0`}>
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  {item.record?.markedBy ? (
                                    <div className="text-xs text-slate-500 mt-0.5 font-sans truncate max-w-full" title={`Marked by ${item.record.markedBy}`}>
                                      Marked by {item.record.markedBy} at {new Date(item.record.markedAt || "").toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                    </div>
                                  ) : (
                                    <div className="text-xs text-indigo-400/60 mt-0.5 tracking-wider uppercase font-bold text-xs truncate max-w-full">
                                      Awaiting Decision
                                    </div>
                                  )}
                                  {(() => {
                              ...
                              <div className="flex flex-col items-center justify-center gap-1.5 min-w-0">
                                ...
                                {item.status === "late" && (
                                  <div className="flex items-center gap-1 mt-1 shrink-0">
                                    <span className="text-xs text-slate-500 uppercase font-bold mr-1">Time:</span>
                                    <input
                                      type="time"
                                      value={lateTimes[item.name] || "09:00"}
                                      onChange={(e) => handleLateTimeChange(item.name, e.target.value)}
                                      className="bg-slate-950 border border-white/10 text-slate-100 rounded px-1.5 py-0.5 text-xs font-sans font-bold focus:outline-none focus:border-indigo-500/50"
                                    />
                                  </div>
                                )}
                              </div>
                      ...
                      return (
                        <div key={item.name} className="p-5 space-y-4 hover:bg-slate-800/10 transition-colors">
                          <div className="flex justify-between items-start">
                            <div className="flex items-center gap-3">
                              <div className={`w-8 h-8 rounded-xl bg-gradient-to-br ${getLOBGradient(item.lob)} flex items-center justify-center text-white text-xs font-bold`}>
                                {getInitials(item.name)}
                              </div>
                              <div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-950/40 border-t border-white/10 p-4">
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  <button
                    ...
                    className="h-8 px-2.5 bg-white/[0.03] border border-white/5 hover:border-white/10 text-slate-400 hover:text-slate-200 disabled:opacity-35 rounded-xl text-xs font-bold transition-all disabled:cursor-not-allowed select-none"
                  >
                    &laquo;
                  </button>
                  <button
                    ...
                    disabled={currentPage === 1}
                    className="h-8 px-3 bg-white/[0.03] border border-white/5 hover:border-white/10 text-slate-400 hover:text-slate-200 disabled:opacity-35 rounded-xl text-xs font-bold transition-all disabled:cursor-not-allowed flex items-center gap-1 select-none"
                  >
                        ...
                        return (
                          <React.Fragment key={p}>
                            ...
                            <button
                              ...
                              className={`w-8 h-8 rounded-xl text-xs font-bold flex items-center justify-center transition-all ${ currentPage === p ? "bg-indigo-500 border border-indigo-500/30 text-white shadow-sm" : "bg-slate-950/30 border border-white/5 text-slate-400 hover:text-slate-100 hover:bg-white/[0.05]" }`}
                            >
                              {p}
                            </button>
                          </React.Fragment>
