...
export const AttendanceTracker: React.FC<AttendanceTrackerProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in text-left font-sans">
      ...
      <div className="bg-transparent border border-white/5 p-5 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-5 shadow-sm">
        <div className="space-y-1">
      ...
      <div className="bg-transparent border border-white/5 p-5 rounded-2xl space-y-3 shadow-inner">
                            ...
                            <button
                              ...
                              className={`w-8 h-8 rounded-xl text-xs font-bold flex items-center justify-center transition-all ${
                                currentPage === p
                                  ...
                                  : "bg-slate-950/30 border border-white/5 text-slate-400 hover:text-slate-100 hover:bg-white/[0.05]"
                              }`}
                            >
                              {p}
                            </button>
  ...
  return (
    <button
      ...
      className={`rounded-xl border font-bold transition-all flex flex-col items-center justify-center cursor-pointer active:scale-95 shrink-0 select-none ${
        ...
        isActive
          ? activeStyle
          : "bg-slate-950/40 border-white/5 text-slate-400 hover:text-slate-100 hover:bg-white/[0.05] hover:border-slate-700/50"
      }`}
    >
