            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-start gap-3.5">
                ...
                <div className="space-y-1">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-xs font-bold uppercase tracking-wider px-2 py-0.5 bg-amber-500/10 text-amber-300 rounded-xl border border-transparent">
                      Live Broadcast
                    </span>
                    ...
                    {latest.clinicFilter && latest.clinicFilter !== 'all' && (
                      <span className="text-xs font-sans px-1.5 py-0.5 bg-transparent border border-white/12 text-white text-indigo-300 rounded border border-transparent">
              ...
              <div className="shrink-0 flex items-center gap-3 self-end md:self-center">
                <button 
                  ...
                  className="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 active:scale-95 text-slate-950 font-bold text-xs uppercase tracking-widest rounded-xl transition-all flex items-center gap-2 cursor-pointer"
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-2">
        ...
        >
          ...
          <div className="relative z-10 text-left">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-white/60 text-xs font-bold uppercase tracking-[0.2em]">Operational Overview</p>
                <h2 className="text-2xl font-bold text-white tracking-tight">Salam, {(currentUser?.name || '').split(' ')[0]} 👋</h2>
                ...
                {currentUser?.role === 'agent' && normalizeAgentLob(currentUser?.lob, currentUser?.role) && (
                  <div className="mt-2">
                    <span className="inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-bold bg-transparent border border-white/12 text-white text-indigo-300 border border-transparent">
          ...
          <div className="relative z-10 flex gap-3 mt-6">
            <button 
              ...
              className="px-5 py-2 bg-white text-indigo-600 rounded-xl font-bold text-xs uppercase tracking-widest active:scale-95 transition-all flex items-center gap-2 cursor-pointer"
            >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="px-3 py-1.5 bg-transparent border border-white/12 text-white text-emerald-400 rounded-lg text-xs font-bold uppercase tracking-widest">
              Active
            </div>
          </div>
          <div>
            <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">Upcoming Rotation</p>
            <h3 className="text-2xl font-bold text-white px-0.5">{myNextShift?.shiftLabel || 'Off Duty'}</h3>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2">
              <h3 className="text-3xl font-bold text-white">{(!isNaN(pendingRequestsCount) ? pendingRequestsCount : 0) + (!isNaN(activeCasesCount) ? activeCasesCount : 0)}</h3>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2">
              <h3 className={`text-3xl font-bold ${avgQaScore && avgQaScore < 70 ? 'text-red-400' : 'text-green-400'}`}>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2">
              <h3 className="text-3xl font-bold text-pink-400">{inquiriesCount}</h3>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-baseline gap-2">
              <h3 className="text-3xl font-bold text-cyan-400">{ttRequestsCount}</h3>
