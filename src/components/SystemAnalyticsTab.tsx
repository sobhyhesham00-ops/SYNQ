  ...
  return (
    <div className="space-y-6 animate-fade-in mb-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="bg-white/5 border border-white/10 p-5 rounded-2xl flex flex-col h-80">
      ...
      <div className="bg-white/5 border border-white/10 p-5 rounded-2xl h-96">
