...
const TimelineStep = ({
  ...
  >
    <div
      className={`w-6 h-6 rounded-full border-2 flex items-center justify-center bg-[#0d0d10] transition-colors ${completed ? "border-indigo-500 bg-indigo-500/10" : active ? "border-slate-500" : "border-slate-800"}`}
    >
  ...
  return (
    <div
      ...
      className={`p-5 bg-[#1f222a] border-none rounded-[24px] hover:bg-[#282c35] transition-all duration-300 relative flex flex-col w-full overflow-hidden shadow-sm ${
        isExpanded
          ? "shadow-md ring-1 ring-white/5 space-y-4"
          ...
          <div className="px-5 py-3 flex items-center gap-2 flex-wrap bg-slate-800/40 border-t border-slate-700/40">
            ...
            {isTLOreSupport && (
              <div className="relative" ref={assignDropdownRef}>
                ...
                {showAssignDropdown && (
                  <div className="absolute bottom-full right-0 mb-2 z-50 bg-[#141419] border border-slate-700/60 rounded-xl w-72 shadow-2xl flex flex-col overflow-hidden">
                    {/* Header */}
