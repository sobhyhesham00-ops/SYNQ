...
export const AGENT_TL_MAP: Record<string, string> = {
  ...
  'Kenzi Reda Ahmed Ali': 'Shymaa Hassan',
  'Mai Ashraf Elsayed': 'Shymaa Hassan',

  // AbdelAlem's team
  'Asmaa Ahmed Mohamed Morsy': 'AbdelAlem Essam AbdelAlem',
  'Bassant Alaa Eldin': 'AbdelAlem Essam AbdelAlem',
  'Fatma Essam Abdelalem': 'AbdelAlem Essam AbdelAlem',
  'Hadeer Mohamed': 'AbdelAlem Essam AbdelAlem',
  'Kholoud Fakhry': 'AbdelAlem Essam AbdelAlem',

  // Emad Sayed's team
  'AbduAllah Salah Fahmy': 'Emad Sayed',
  'Ahmed Eid Abdelbaset Eid': 'Emad Sayed',
  'Amr Mohamed Farouk Mohamed': 'Emad Sayed',
  'Eslam Samy Ashour Ali': 'Emad Sayed',
  'Hussein Ashraf': 'Emad Sayed',
  'Jodie El Sayed Mohamed Mohamed': 'Emad Sayed',
  'Kotoz Sami Mohamed': 'Emad Sayed',
  'Mariam Nagy Eraky': 'Emad Sayed',
  'Mariam walaa Gamal Mostafa': 'Emad Sayed',
  'Mennatallah Ahmed el sayed Salem': 'Emad Sayed',
  'Mohamed Alaa': 'Emad Sayed',
  'Mohamed Amer Mohy El Din': 'Emad Sayed',
  'Mostafa Mahmoud Hamed Abd El Ghany': 'Emad Sayed',
  'Nouran Mohamed Saad Eldin Tawfik': 'Emad Sayed',
  'Nouran Sharqawi': 'Emad Sayed',
  'Salma Ahmed Mohamed Kamel': 'Emad Sayed',
  'Yomna Mohamed Ahmed': 'Emad Sayed',
  'Youssef Magdy Hamad Abo Al Ainen': 'Emad Sayed',
  'Zeina Yasser Nessim Selim': 'Emad Sayed',
  'Hana Alaa': 'Emad Sayed',
  'Basma Rabea': 'Emad Sayed',
  'Amira Hassan': 'Emad Sayed',
};
...
export interface AttendanceRecord {
  ...
  agentName: string;
  date: string; // YYYY-MM-DD
  status: 'present' | 'absent' | 'late' | 'casual' | 'annual' | 'sick' | 'nsnc' | 'off' | 'not_marked';
