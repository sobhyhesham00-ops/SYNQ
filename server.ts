...
async function startServer() {
  ...
  // API Request: AI Schedule Roster Analyzer
  app.post("/api/analyze-schedule", async (req, res) => {
    try {
      ...
      // Format schedule items into compact summary representation
...
`;
  ...
  // API Request: AI General Assistant Chat
  ...
  // Integrate Vite middleware in development, serve static files in production
